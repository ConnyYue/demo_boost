...
//            Log.d("cccLog", "跳转原生嵌套页面存在问题");
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        Log.v("cccLog", "#onActivityResult, requestCode=" + requestCode + ", resultCode=" + resultCode + ", data=" + data.getSerializableExtra(ACTIVITY_RESULT_KEY));
    }
}
